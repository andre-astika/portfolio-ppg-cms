...
// All CMS content lives in flat JSON files under /data. This keeps the CMS
// dependency-free (no database server needed). The rest of the app only
// talks to these read/write functions, never to the filesystem directly.
